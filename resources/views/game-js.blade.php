...
var prizes = [
  ...
  function initHTML() {
    ...
    <!-- The Modal -->
      ...
      <!-- End of Modal Award -->
      </div>  <div id="cnvWheelLoading" style="position: fixed; top: 0; left: 0; z-index: 999; width: 100%; height: 100%; background-color: white; -webkit-transition: opacity 1000ms linear; transition: opacity 1000ms linear;"></div>`;
  }
  initHTML();
